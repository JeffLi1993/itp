...
(function($){
	...
	$.fn.datepicker = function(opts){
		var setting = {
			box$:"#schedule",
			year$:"#schedule [name=year]", month$:"#schedule [name=month]",
			tmInputs$:"#schedule .time :text", hour$:"#schedule .time .hh", minute$:"#schedule .time .mm", second$:"#schedule .time .ss",
			tmBox$:"#schedule .tm", tmUp$:"#schedule .time .up", tmDown$:"#schedule .time .down",
			close$:"#schedule .close", calIcon$:"a.inputDateButton",
			main$:"#schedule .main", days$:"#schedule .days", dayNames$:"#schedule .dayNames",
			clearBut$:"#schedule .clearBut", okBut$:"#schedule .okBut"
		};
