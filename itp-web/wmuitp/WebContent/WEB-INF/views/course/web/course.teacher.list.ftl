<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/courseTeacherRelation/showCourseTeacherRelationAdd" target="dialog" width="450" height="300" title="新增课程和老师" mask = "true" rel="staffAdd"><span>新增课程和老师</span></a></li>
			<li><a class="edit" href="${ctx}/courseTeacherRelation/showCourseTeacherRelationAdd?CTRId={teacherCourse}" target="dialog" width="450" height="300" title="修改课程和老师" mask = "true" rel="staffEdit"><span>修改课程和老师</span></a></li>
			<li><a class="delete"   href="#" onclick="objDelete('teacherCourse', '${ctx}/courseTeacherRelation/courseTeacherRelationDelete', '${ctx}/courseTeacherRelation/courseTeacherRelations', 'courseTeacherRelations');return false;" title="支持批量删除" rel="courseTeacherRelationDelete"><span>删除</span></a></li>
		</ul>
	</div>
	...
	<form id="pagerForm" method="post" action="${ctx}/courseTeacherRelation/courseTeacherRelations">
