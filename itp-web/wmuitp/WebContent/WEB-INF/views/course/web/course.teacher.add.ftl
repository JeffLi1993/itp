<div class="pageFormContent" layoutH="0">
	...
	<form id="courseTeacherRelationAddForm" method="POST" class="pageForm required-validate" action="${ctx}/courseTeacherRelation/courseTeacherRelationAdd" style="float:left">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="430" class="tableShowCont">
			...
			<tr>
				<td>	
					<label style="width:80px;">所属老师：</label>
					<a class="btnLook" style="float:right;" href="${ctx}/teacherInfo/teacherInfoLookup" lookupGroup="" width="1250">查找带回</a>
				</td>
				<td>
					<div  class="select">
						<input  name="teacherInfoName" type="text" readonly="readonly" class="required" value="${(courseTeacherRelation.teacherInfo.tiName)?default('')}" >
						<input  name="teacherInfoID" type="hidden" value="${(courseTeacherRelation.teacherInfo.tiId)?default('')}"  />
					</div>
				</td>
			</tr>
			<tr>
