<div class="pageFormContent" layoutH="0">
	...
	<form id="discussionTopicAddForm" method="POST" class="pageForm required-validate" action="${ctx}/discussionTopic/discussionTopicAddTea" style="float:left">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="430" class="tableShowCont">
			<tr>
				<td>
					...
					<a class="btnLook" href="${ctx}/courseInfo/courseInfoLookUpByTeaSession" lookupGroup="" width="650">查找带回</a>
				</td>
				<td>	
			...
			<tr>
				<td>
					<label style="width:90px">议题题目：</label> 
				</td>
				<td>	
			...
			<tr>
				...
				<td>	
					<textarea  cols="40" rows="3"  name="dtContent">${(discussionTopic.dtContent)?default("")}</textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2">
