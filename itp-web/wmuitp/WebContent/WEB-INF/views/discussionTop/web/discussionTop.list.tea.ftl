<div class="pageHeader">
	<form id="pagerForm" method="post" action="${ctx}/discussionTopic/discussionTopicsTea">
		<div class="searchBar">
			<table>
				<tr>
					...
					<td>
						<div class="buttonActive">
							<div class="buttonContent">
								<button  onclick="navTab.reload('${ctx}/discussionTopic/discussionTopicsTea?pageNo=1', {},'discussionTopics');return false;">
								检索
								</button>
							</div>
						</div>
...
<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" 		href="${ctx}/discussionTopic/showDiscussionTopicAddTea" target="dialog" width="450" height="285"  title="新增议题" mask = "true" rel="showDiscussionTopicAdd"><span>新增议题</span></a></li>
			<li><a class="edit" 	href="${ctx}/discussionTopic/showDiscussionTopicAddTea?discussionTopicId={discussionTopic}" target="dialog"width="450" height="285" title="修改议题" mask = "true" rel="showDiscussionTopicEdit"><span>修改议题</span></a></li>
			<li><a class="delete"   href="#" onclick="objDelete('discussionTopic', '${ctx}/discussionTopic/discussionTopicDeleteTea', '${ctx}/discussionTopic/discussionTopicsTea', 'discussionTopics');return false;" title="支持批量删除" rel="discussionTopicDelete"><span>删除</span></a></li>
		</ul>
	</div>
