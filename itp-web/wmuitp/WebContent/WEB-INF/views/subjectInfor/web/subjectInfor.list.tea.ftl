<div class="pageHeader">
	<form id="pagerForm" method="post" action="${ctx}/subjectInfor/subjectInforsTea">
		<div class="searchBar">
			<table>
				<tr>
...
<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" 		href="${ctx}/subjectInfor/showSubjectInforAddTea" target="dialog" width="380" height="450" title="新增测试题" mask = "true" rel="subjectInforAdd"><span>新增测试题</span></a></li>
			<li><a class="edit" 	href="${ctx}/subjectInfor/showSubjectInforAddTea?subjectInforID={subjectInfor}" target="dialog" width="380" height="450" title="修改测试题" mask = "true" rel="subjectInforEdit"><span>修改测试题</span></a></li>
			<li><a class="delete"   href="#" onclick="objDelete('subjectInfor', '${ctx}/subjectInfor/subjectInforDeleteTea', '${ctx}/subjectInfor/subjectInforsTea', 'subjectInfors');return false;" title="支持批量删除" rel="subjectInforDelete"><span>删除</span></a></li>
			<li><a class="add" 		href="${ctx}/subjectInfor/showSubjectInforAddByXls" target="dialog" width="450" height="180" title="新增测试题" mask = "true" rel="subjectInforAddXls"><span>新增测试题xls</span></a></li>
		</ul>
	</div>
