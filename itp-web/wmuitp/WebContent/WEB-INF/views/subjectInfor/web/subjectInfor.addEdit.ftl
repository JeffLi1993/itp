<div class="pageFormContent" layoutH="20">
	...
	<form id="subjectInforAddForm" method="POST" class="pageForm required-validate" action="${ctx}/subjectInfor/subjectInforAdd" style="width:350px;float:left">
		...
		<p style="width:340px;float:left">
			...
			<a class="btnLook" href="${ctx}/courseChapter/showCourseChapterLookUp" lookupGroup="" >查找带回</a>
		...
		<p style="width:340px;float:left">
			...
			<a class="btnLook" href="${ctx}/teacherInfo/teacherInfoLookup" lookupGroup="" >查找带回</a>
			<input  name="teacherInfoName" type="text" readonly="readonly" class="required" value = "${(subjectInfor.courseChapter.course.CName)?default("")}${(subjectInfor.courseChapter.ccName)?default("")}" >
			<input  name="teacherInfoID" type="hidden"  value = "${(subjectInfor.courseChapter.ccId)?default("")}" />
		</p>
