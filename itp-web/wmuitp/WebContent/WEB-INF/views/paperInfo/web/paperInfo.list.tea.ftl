<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" 		href="${ctx}/paperInfo/showPaperInfoAddTea" target="dialog" width="520" height="450" title="新增测试试卷" rel="paperInfoAdd"><span>新增测试试卷</span></a></li>
			<li><a class="edit" 	href="${ctx}/paperInfo/showPaperInfoAddTea?paperInfoId={paperInfo}" target="dialog" width="520" height="450" title="修改测试试卷" mask = "true" rel="paperInfoEdit"><span>修改测试试卷</span></a></li>
			...
			<li><a class="add" 		href="${ctx}/paperInfo/showExamStatisticalTea" target="dialog" width="450" height="220" title="导出测试情况" rel="showExamStatistical"><span>导出测试情况</span></a></li>
		</ul>
	</div>
