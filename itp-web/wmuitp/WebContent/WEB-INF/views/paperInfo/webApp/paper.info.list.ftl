<div class="xmyTab">
	<ul>
		<li><a href="#" id="courseInfoButton" onclick="divload('contentYwl','${ctx}/courseInfo/getCourseInfoByCIIIdApp?courseInfoId=${courseInfoId}')">课程详情</a></li>
		<li class="xtabChooes"><a href="#"  >课堂测试</a></li>
		<li><a href="#" onclick="divload('contentYwl','${ctx}/discussionTopic/getDiscussionTopicByCIIdApp?courseInfoId=${courseInfoId}')">议题</a></li>
	</ul>	
</div>
