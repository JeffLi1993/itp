<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" 		href="${ctx}/courseInfo/showCourseInfoAdd" target="dialog" width="450" height="450" title="新增课详情" mask = "true" rel="courseInfoAdd"><span>新增课详情</span></a></li>
		</ul>
	</div>
			...
			<#if page.getResult()?exists>
				<#list page.getResult() as courseInfoDetail>
					<tr target="courseInfo" rel="${courseInfoDetail.courseInfo.ciId}" >
						...
						<td>${courseInfoDetail.courseInfo.ciId}</td>
						<td>
							${courseInfoDetail.courseInfo.courseTeacherRelation.course.CName}
						</td>
	...
	<form id="pagerForm" method="post" action="${ctx}/courseInfo/courseInfos">
