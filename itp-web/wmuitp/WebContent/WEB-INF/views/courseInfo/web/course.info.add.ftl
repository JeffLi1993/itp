...
<div class="pageFormContent" layoutH="20" style="width:600px;">
	...
	<form id="courseInfoAddForm" method="POST" class="pageForm required-validate" action="${ctx}/courseInfo/courseInfoAdd" style="float:left">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="430" class="tableShowCont">
		<tr>
			<td width="80">
				<label class="labelShowBox">上课时间：</label>
			</td>
			<td>
		...
		<tr>
			<td><label class="labelShowBox">节数：</label></td>
			<td>
				<select name = "ciPeriod" id = "ciPeriod" onchange="getClassOverTime()" onfocus="validate1()">
		...
		<tr>
			<td><label class="labelShowBox">课程结束时间：</label></td>
			<td>
		...
		<tr>
			...
			<td>
				<textarea name="className"   readonly="readonly" class="required" cols="40" rows="5" width="194" style="width: 194px"></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2">
