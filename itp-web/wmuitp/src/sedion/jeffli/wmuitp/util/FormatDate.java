...
public class FormatDate {
	 ...
	 * @throws ParseException 
	 */
	public static boolean dateCompare(Date date1,Date date2) throws ParseException{
		date1 = stringToDate(dateToString(date1));
		date2 = stringToDate(dateToString(date2));
	...
	//计算两个string类的时间差
	public static String timeRemaining(String endTime) throws ParseException{
		String startTime = getFormateDateAll();
		System.out.println(startTime+endTime);
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");					// 格式化时间   
		Date outdate = sdf.parse(endTime);    
		Date indate =  sdf.parse(startTime); 
		long totaldaies = (outdate.getTime()-indate.getTime())/(1000*60*60*60);				//天
		long totalhours = (outdate.getTime()-indate.getTime())%(1000*60*60*60)/(1000*60*60);	//时   
		long totalminutes = (outdate.getTime()-indate.getTime())%(1000*60*60*60)%(1000*60*60)/(1000*60);	//分   
		long totalseconds = (outdate.getTime()-indate.getTime())%(1000*60*60*60)%(1000*60*60)%(1000*60)/(1000);	//秒   
		String total_time = totaldaies+"天"+totalhours+"时"+totalminutes+"分"+totalseconds+"秒";  
		return total_time;
	}
	//计算两个时间之差，返回秒数
	...
	public static String dateToStringAll(Date date) throws ParseException{
		...
		/*public static void main(String[] args) throws ParseException {
			...
			public static void main(String[] args) throws ParseException 
			{
				...
				Date data = stringToDateAll("2014-07-03 Thursday 11:46:00");
