...
public class JobCourseInfo implements Job{
	
	public  static String COUSER_INFO	=	"courseInfo";
	
    public JobCourseInfo() {}    
    ...
    {  
    	...
    	try
    	{
    		System.out.println("课任务启动.....");
    		//courseInfoService.turnCIStateTureByCourseInfoId(courseInfoId);
    		
    		DbConn.exceptQuery("update course_info set CI_State = 'T' where CI_ID='"+data.getInt(COUSER_INFO)+"'");
    		
    		System.out.println("课任务启动Success.....");
    	}
    	catch (Exception e) 
    	{
			throw new QuartzException("JobCourseInfo execute() ERROR !!", e);
		}
    }  
